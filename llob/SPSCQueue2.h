...
public:
  ...
  SPSCQueue2(const SPSCQueue2&) = delete;
  SPSCQueue2(SPSCQueue2&&) = delete;
  SPSCQueue2& operator=(const SPSCQueue2&) = delete;
  SPSCQueue2& operator=(SPSCQueue2&&) = delete;
...
private:
  ...
  alignas(CACHE_LINE_SIZE) alignas(T) std::byte storage_[sizeof(T)*Size];
